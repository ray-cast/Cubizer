...
namespace Cubizer
{
	...
	public class ChunkEntity : ICloneable
	{
		...
		public struct Cube
		{
			...
			public static void CreateCubeMesh16x16(ref Vector3[] vertices, ref Vector3[] normals, ref Vector2[] uv, ref int[] triangles, ref int index, VisiableFaces faces, Vector3 translate, Vector3 scale, uint palette)
			{
				bool[] visiable = new bool[] { faces.left, faces.right, faces.top, faces.bottom, faces.front, faces.back };
		...
		public static void CreateCubeMesh16x16(ref Vector3[] vertices, ref Vector3[] normals, ref Vector2[] uv, ref int[] triangles, ref int index, VisiableFaces faces, Vector3 translate, Vector3 scale, uint palette)
		{
			Cube.CreateCubeMesh16x16(ref vertices, ref normals, ref uv, ref triangles, ref index, faces, translate, scale, palette);
		}
