...
namespace Cubizer
{
	namespace Model
	{
		public class VOXModel
		{
			...
			{
				Vector3 pos;
				pos.x = (it.begin_x + it.end_x + 1) * 0.5f * scaling;
				pos.y = (it.begin_y + it.end_y + 1) * 0.5f * scaling;
				pos.z = (it.begin_z + it.end_z + 1) * 0.5f * scaling;

				Vector3 scale;
				scale.x = (it.end_x + 1 - it.begin_x) * scaling;
				scale.y = (it.end_y + 1 - it.begin_y) * scaling;
				scale.z = (it.end_z + 1 - it.begin_z) * scaling;
